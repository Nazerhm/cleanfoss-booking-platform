...
export default function VehicleSelection() {
  ...
  const handleVehicleTypeSelect = (vehicleType: VehicleType) => {
    ...
    // Create a temporary vehicle object for the booking
    const tempVehicle = {
      id: `temp-${vehicleType.id}`,
      make: vehicleType.name,
      model: 'Generic',
      year: new Date().getFullYear(),
      type: vehicleType.id.toUpperCase() as any,
      licensePlate: '',
      size: vehicleType.id === 'small-car' ? 'SMALL' as any : 
            vehicleType.id === 'large-car' || vehicleType.id === 'van' ? 'LARGE' as any : 
            'MEDIUM' as any,
    };
